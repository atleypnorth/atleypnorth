...
BLOG_AUTHOR = "Patrick Morris"  # (translatable)
BLOG_TITLE = "Code, cooking, Cthulhu etc"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://atleypnorth.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "patrick@shimi.co.uk"
BLOG_DESCRIPTION = "Patrick's blog."  # (translatable)
...
#<li><a href="https://twitter.com/atleypnorthuk" class="twitter-follow-button" data-show-count="false">Follow @atleypnorthuk</a><script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
#</ul>
#</div>
